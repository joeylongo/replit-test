export default (recordData: any, variationPrompt?: string, productHierarchy?: any) =>
...
- ${productHierarchy.l3DisplayName}
...
${productHierarchy ? `Your product description must match the following: ${productHierarchy.l3DisplayName}` : ''}
